...
parser.add_argument("--net", type=str, default="RCAN", help="RCAN, ESRGAN, SAN, RDN, EPSR, SRFAN, ours")
parser.add_argument("--denoiser", type=str, default="None", help="previous denoisor")
parser.add_argument("--test_path", type=str, default='../../results/', help="Directory where test images are stored")
parser.add_argument("--gt_path", type=str, default='../../data/all/sim/', help="Directory where GT images are stored")
